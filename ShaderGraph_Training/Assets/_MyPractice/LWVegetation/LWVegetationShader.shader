/// Reference from: https://github.com/Verasl/BoatAttack
/// Add Wind direction and Wind frequence
Shader "Custom/LWVegetationShader"
{
    Properties
    {
		...
		_WindDirectionX("Wind Direction X", Range(-5.0, 5.0)) = 0.0
		_WindDirectionZ("Wind Direction Z", Range(-5.0, 5.0)) = 0.0
		_WindFrequency("Wind Frequency", Range(0.0, 5.0)) = 1.0
    }
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			VegetationVertexOutput VegetationVertex(VegetationVertexInput input)
			{
                ...
                input.positionOS = VegetationDeformation(input.positionOS, objectOrigin.xyz, input.normalOS, input.color.x,
					input.color.z, input.color.y, _BendStrength, _WindDirectionX, _WindDirectionZ, _WindFrequency);
				//////////////////////////////////////////////////////////////////////////////////////////////////////
                #endif
			...
			#ifdef _ADDITIONAL_LIGHTS
				output.posWS = vertexPosition.positionWS;
			#endif
